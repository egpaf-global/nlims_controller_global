...
class API::V1::OrderController < ApplicationController
  ...
  def create_order
    required_params = %w[district health_facility_name requesting_clinician first_name last_name phone_number gender
                         national_patient_id sample_type tests date_sample_drawn sample_status sample_priority
                         target_lab order_location who_order_test_first_name who_order_test_last_name]
