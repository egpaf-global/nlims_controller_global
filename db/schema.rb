...
ActiveRecord::Schema.define(version: 20220929084415) do
  ...
  create_table "test_result_recepient_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "name"
    t.string "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
